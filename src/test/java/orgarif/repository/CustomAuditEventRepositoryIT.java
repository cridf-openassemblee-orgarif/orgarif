...
import orgarif.config.audit.AuditEventConverter;
import orgarif.domain.PersistentAuditEvent;
...
import static orgarif.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
