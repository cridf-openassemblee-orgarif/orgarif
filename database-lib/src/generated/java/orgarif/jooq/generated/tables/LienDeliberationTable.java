...
public class LienDeliberationTable extends TableImpl<LienDeliberationRecord> {
     ...
     */
    public final TableField<LienDeliberationRecord, Instant> CREATION_DATE = createField(DSL.name("creation_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", new TimestampWithTimeZoneToInstantJooqConverter());

    /**
     * The column <code>public.lien_deliberation.last_modification_date</code>.
     */
    public final TableField<LienDeliberationRecord, Instant> LAST_MODIFICATION_DATE = createField(DSL.name("last_modification_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", new TimestampWithTimeZoneToInstantJooqConverter());
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.LIEN_DELIBERATION_ORGANISME_ID_IDX);
    }
    ...
    public List<ForeignKey<LienDeliberationRecord, ?>> getReferences() {
        return Arrays.asList(Keys.LIEN_DELIBERATION__LIEN_DELIBERATION_ORGANISME_ID_FKEY, Keys.LIEN_DELIBERATION__LIEN_DELIBERATION_INSTANCE_ID_FKEY, Keys.LIEN_DELIBERATION__LIEN_DELIBERATION_DELIBERATION_ID_FKEY);
    }
    ...
    @Override
    @Nonnull
    public LienDeliberationTable as(Table<?> alias) {
        return new LienDeliberationTable(alias.getQualifiedName(), this);
    }
    ...
    @Override
    @Nonnull
    public LienDeliberationTable rename(Table<?> name) {
        return new LienDeliberationTable(name.getQualifiedName(), null);
    }
     ...
     */
    public <U> SelectField<U> mapping(Function8<? super UUID, ? super UUID, ? super UUID, ? super UUID, ? super String, ? super String, ? super Instant, ? super Instant, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function8<? super UUID, ? super UUID, ? super UUID, ? super UUID, ? super String, ? super String, ? super Instant, ? super Instant, ? extends U> from) {
