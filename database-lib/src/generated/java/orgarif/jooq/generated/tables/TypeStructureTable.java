...
public class TypeStructureTable extends TableImpl<TypeStructureRecord> {
     ...
     */
    public final TableField<TypeStructureRecord, String> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.type_structure.creation_date</code>.
     */
    public final TableField<TypeStructureRecord, Instant> CREATION_DATE = createField(DSL.name("creation_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", new TimestampWithTimeZoneToInstantJooqConverter());

    /**
     * The column <code>public.type_structure.last_modification_date</code>.
     */
    public final TableField<TypeStructureRecord, Instant> LAST_MODIFICATION_DATE = createField(DSL.name("last_modification_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", new TimestampWithTimeZoneToInstantJooqConverter());
    ...
    @Override
    @Nonnull
    public TypeStructureTable as(Table<?> alias) {
        return new TypeStructureTable(alias.getQualifiedName(), this);
    }
    ...
    @Override
    @Nonnull
    public TypeStructureTable rename(Table<?> name) {
        return new TypeStructureTable(name.getQualifiedName(), null);
    }
