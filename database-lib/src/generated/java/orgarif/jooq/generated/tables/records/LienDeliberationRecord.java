...
public class LienDeliberationRecord extends UpdatableRecordImpl<LienDeliberationRecord> implements Record8<UUID, UUID, UUID, UUID, String, String, Instant, Instant> {
    ...
    @Override
    @Nonnull
    public Row8<UUID, UUID, UUID, UUID, String, String, Instant, Instant> valuesRow() {
    ...
    @Override
    @Nonnull
    public LienDeliberationRecord values(@Nonnull UUID value1, @Nonnull UUID value2, @Nullable UUID value3, @Nonnull UUID value4, @Nullable String value5, @Nonnull String value6, @Nonnull Instant value7, @Nonnull Instant value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LienDeliberationRecord(@Nonnull UUID id, @Nonnull UUID organismeId, @Nullable UUID instanceId, @Nonnull UUID deliberationId, @Nullable String comment, @Nonnull String status, @Nonnull Instant creationDate, @Nonnull Instant lastModificationDate) {
        super(LienDeliberationTable.LIEN_DELIBERATION);
