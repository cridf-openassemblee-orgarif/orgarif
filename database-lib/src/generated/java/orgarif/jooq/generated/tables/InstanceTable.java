...
public class InstanceTable extends TableImpl<InstanceRecord> {
     ...
     */
    public final TableField<InstanceRecord, Instant> CREATION_DATE = createField(DSL.name("creation_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", new TimestampWithTimeZoneToInstantJooqConverter());

    /**
     * The column <code>public.instance.last_modification_date</code>.
     */
    public final TableField<InstanceRecord, Instant> LAST_MODIFICATION_DATE = createField(DSL.name("last_modification_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", new TimestampWithTimeZoneToInstantJooqConverter());
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.INSTANCE_ORGANISME_ID_IDX);
    }
    ...
    public List<ForeignKey<InstanceRecord, ?>> getReferences() {
        return Arrays.asList(Keys.INSTANCE__INSTANCE_ORGANISME_ID_FKEY);
    }
     ...
     */
    public <U> SelectField<U> mapping(Function8<? super UUID, ? super String, ? super UUID, ? super Integer, ? super Boolean, ? super String, ? super Instant, ? super Instant, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function8<? super UUID, ? super String, ? super UUID, ? super Integer, ? super Boolean, ? super String, ? super Instant, ? super Instant, ? extends U> from) {
