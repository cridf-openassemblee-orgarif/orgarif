...
val APP_USER_MAIL_IDX: Index =
    Internal.createIndex(
        ...
        false)
val DESIGNATION_INSTANCE_ID_IDX: Index =
    Internal.createIndex(
        DSL.name("designation_instance_id_idx"),
        DesignationTable.DESIGNATION,
        arrayOf(DesignationTable.DESIGNATION.INSTANCE_ID),
        false)
val DESIGNATION_ORGANISME_ID_IDX: Index =
    Internal.createIndex(
        DSL.name("designation_organisme_id_idx"),
        DesignationTable.DESIGNATION,
...
val INSTANCE_ORGANISME_ID_IDX: Index =
    Internal.createIndex(
        ...
        false)
val LIEN_DELIBERATION_ORGANISME_ID_IDX: Index =
    Internal.createIndex(
        DSL.name("lien_deliberation_organisme_id_idx"),
...
val MAIL_LOG_USER_ID_IDX: Index =
    Internal.createIndex(
        ...
        false)
val ORGANISME_DEPARTEMENT_ID_IDX: Index =
    Internal.createIndex(
        DSL.name("organisme_departement_id_idx"),
        OrganismeTable.ORGANISME,
        arrayOf(OrganismeTable.ORGANISME.DEPARTEMENT_ID),
        false)
val ORGANISME_NATURE_JURIDIQUE_ID_IDX: Index =
    Internal.createIndex(
        DSL.name("organisme_nature_juridique_id_idx"),
        OrganismeTable.ORGANISME,
        arrayOf(OrganismeTable.ORGANISME.NATURE_JURIDIQUE_ID),
        false)
val ORGANISME_SECTEUR_ID_IDX: Index =
    Internal.createIndex(
        DSL.name("organisme_secteur_id_idx"),
        OrganismeTable.ORGANISME,
        arrayOf(OrganismeTable.ORGANISME.SECTEUR_ID),
        false)
val ORGANISME_TYPE_STRUCTURE_ID_IDX: Index =
    Internal.createIndex(
        DSL.name("organisme_type_structure_id_idx"),
        OrganismeTable.ORGANISME,
