...
open class PublicTable : SchemaImpl("public", DefaultCatalog.DEFAULT_CATALOG) {
    ...
    val DEPARTEMENT: DepartementTable
        get() = DepartementTable.DEPARTEMENT
    ...
    val DESIGNATION: DesignationTable
        get() = DesignationTable.DESIGNATION
    ...
    val LIEN_DELIBERATION: LienDeliberationTable
        get() = LienDeliberationTable.LIEN_DELIBERATION
    ...
    val NATURE_JURIDIQUE: NatureJuridiqueTable
        get() = NatureJuridiqueTable.NATURE_JURIDIQUE
    ...
    val TYPE_STRUCTURE: TypeStructureTable
        get() = TypeStructureTable.TYPE_STRUCTURE
