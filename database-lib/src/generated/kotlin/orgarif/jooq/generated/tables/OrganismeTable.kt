...
open class OrganismeTable(
     ...
     */
    val ID: TableField<OrganismeRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false), this, "")

    /**
     * The column <code>public.organisme.nom</code>.
     */
    val NOM: TableField<OrganismeRecord, String?> = createField(DSL.name("nom"), SQLDataType.VARCHAR(255).nullable(false), this, "")

    /**
     * The column <code>public.organisme.departement_id</code>.
     */
    val DEPARTEMENT_ID: TableField<OrganismeRecord, UUID?> = createField(DSL.name("departement_id"), SQLDataType.UUID, this, "")

    /**
     * The column <code>public.organisme.nature_juridique_id</code>.
     */
    val NATURE_JURIDIQUE_ID: TableField<OrganismeRecord, UUID?> = createField(DSL.name("nature_juridique_id"), SQLDataType.UUID, this, "")

    /**
     * The column <code>public.organisme.secteur_id</code>.
     */
    val SECTEUR_ID: TableField<OrganismeRecord, UUID?> = createField(DSL.name("secteur_id"), SQLDataType.UUID, this, "")

    /**
     * The column <code>public.organisme.type_structure_id</code>.
     */
    val TYPE_STRUCTURE_ID: TableField<OrganismeRecord, UUID?> = createField(DSL.name("type_structure_id"), SQLDataType.UUID, this, "")

    /**
     * The column <code>public.organisme.nombre_representants</code>.
     */
    val NOMBRE_REPRESENTANTS: TableField<OrganismeRecord, Int?> = createField(DSL.name("nombre_representants"), SQLDataType.INTEGER.nullable(false), this, "")

    /**
     * The column <code>public.organisme.presence_suppleants</code>.
     */
    val PRESENCE_SUPPLEANTS: TableField<OrganismeRecord, Boolean?> = createField(DSL.name("presence_suppleants"), SQLDataType.BOOLEAN.nullable(false), this, "")

    /**
     * The column <code>public.organisme.status</code>.
     */
    val STATUS: TableField<OrganismeRecord, String?> = createField(DSL.name("status"), SQLDataType.VARCHAR(255).nullable(false), this, "")

    /**
     * The column <code>public.organisme.creation_date</code>.
     */
    val CREATION_DATE: TableField<OrganismeRecord, Instant?> = createField(DSL.name("creation_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", TimestampWithTimeZoneToInstantJooqConverter())

    /**
     * The column <code>public.organisme.last_modification_date</code>.
     */
    val LAST_MODIFICATION_DATE: TableField<OrganismeRecord, Instant?> = createField(DSL.name("last_modification_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", TimestampWithTimeZoneToInstantJooqConverter())

    private constructor(alias: Name, aliased: Table<OrganismeRecord>?): this(alias, null, null, aliased, null)
    private constructor(alias: Name, aliased: Table<OrganismeRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, aliased, parameters)
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, OrganismeRecord>): this(Internal.createPathAlias(child, key), child, key, ORGANISME, null)
    override fun getSchema(): Schema? = if (aliased()) null else PublicTable.PUBLIC
    override fun getIndexes(): List<Index> = listOf(ORGANISME_DEPARTEMENT_ID_IDX, ORGANISME_NATURE_JURIDIQUE_ID_IDX, ORGANISME_SECTEUR_ID_IDX, ORGANISME_TYPE_STRUCTURE_ID_IDX)
    override fun getPrimaryKey(): UniqueKey<OrganismeRecord> = ORGANISME_PKEY
    override fun getReferences(): List<ForeignKey<OrganismeRecord, *>> = listOf(ORGANISME__ORGANISME_NATURE_JURIDIQUE_ID_FKEY, ORGANISME__ORGANISME_SECTEUR_ID_FKEY, ORGANISME__ORGANISME_TYPE_STRUCTURE_ID_FKEY)
    ...
    /**
     * Get the implicit join path to the <code>public.nature_juridique</code>
     * table.
     */
    fun natureJuridique(): NatureJuridiqueTable {
        if (!this::_natureJuridique.isInitialized)
            _natureJuridique = NatureJuridiqueTable(this, ORGANISME__ORGANISME_NATURE_JURIDIQUE_ID_FKEY)
    ...
    /**
     * Get the implicit join path to the <code>public.type_structure</code>
     * table.
     */
    ...
    override fun `as`(alias: Table<*>): OrganismeTable = OrganismeTable(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): OrganismeTable = OrganismeTable(name.getQualifiedName(), null)
     ...
     */
    fun <U> mapping(from: (UUID?, String?, UUID?, UUID?, UUID?, UUID?, Int?, Boolean?, String?, Instant?, Instant?) -> U): SelectField<U> = convertFrom(Records.mapping(from))

    /**
     * Convenience mapping calling {@link SelectField#convertFrom(Class,
     * Function)}.
     */
    fun <U> mapping(toType: Class<U>, from: (UUID?, String?, UUID?, UUID?, UUID?, UUID?, Int?, Boolean?, String?, Instant?, Instant?) -> U): SelectField<U> = convertFrom(toType, Records.mapping(from))
}
