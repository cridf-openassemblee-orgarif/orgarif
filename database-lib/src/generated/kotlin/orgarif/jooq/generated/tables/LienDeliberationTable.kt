...
open class LienDeliberationTable(
     ...
     */
    val ID: TableField<LienDeliberationRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false), this, "")

    /**
     * The column <code>public.lien_deliberation.organisme_id</code>.
     */
    val ORGANISME_ID: TableField<LienDeliberationRecord, UUID?> = createField(DSL.name("organisme_id"), SQLDataType.UUID.nullable(false), this, "")

    /**
     * The column <code>public.lien_deliberation.instance_id</code>.
     */
    val INSTANCE_ID: TableField<LienDeliberationRecord, UUID?> = createField(DSL.name("instance_id"), SQLDataType.UUID, this, "")

    /**
     * The column <code>public.lien_deliberation.deliberation_id</code>.
     */
    val DELIBERATION_ID: TableField<LienDeliberationRecord, UUID?> = createField(DSL.name("deliberation_id"), SQLDataType.UUID.nullable(false), this, "")

    /**
     * The column <code>public.lien_deliberation.comment</code>.
     */
    val COMMENT: TableField<LienDeliberationRecord, String?> = createField(DSL.name("comment"), SQLDataType.CLOB, this, "")

    /**
     * The column <code>public.lien_deliberation.status</code>.
     */
    val STATUS: TableField<LienDeliberationRecord, String?> = createField(DSL.name("status"), SQLDataType.VARCHAR(255).nullable(false), this, "")

    /**
     * The column <code>public.lien_deliberation.creation_date</code>.
     */
    val CREATION_DATE: TableField<LienDeliberationRecord, Instant?> = createField(DSL.name("creation_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", TimestampWithTimeZoneToInstantJooqConverter())

    /**
     * The column <code>public.lien_deliberation.last_modification_date</code>.
     */
    val LAST_MODIFICATION_DATE: TableField<LienDeliberationRecord, Instant?> = createField(DSL.name("last_modification_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", TimestampWithTimeZoneToInstantJooqConverter())

    private constructor(alias: Name, aliased: Table<LienDeliberationRecord>?): this(alias, null, null, aliased, null)
    private constructor(alias: Name, aliased: Table<LienDeliberationRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, aliased, parameters)
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, LienDeliberationRecord>): this(Internal.createPathAlias(child, key), child, key, LIEN_DELIBERATION, null)
    ...
    override fun getReferences(): List<ForeignKey<LienDeliberationRecord, *>> = listOf(LIEN_DELIBERATION__LIEN_DELIBERATION_ORGANISME_ID_FKEY, LIEN_DELIBERATION__LIEN_DELIBERATION_INSTANCE_ID_FKEY, LIEN_DELIBERATION__LIEN_DELIBERATION_DELIBERATION_ID_FKEY)
    ...
    fun organisme(): OrganismeTable {
        if (!this::_organisme.isInitialized)
            _organisme = OrganismeTable(this, LIEN_DELIBERATION__LIEN_DELIBERATION_ORGANISME_ID_FKEY)
    ...
    fun deliberation(): DeliberationTable {
        if (!this::_deliberation.isInitialized)
            _deliberation = DeliberationTable(this, LIEN_DELIBERATION__LIEN_DELIBERATION_DELIBERATION_ID_FKEY)
    ...
    override fun `as`(alias: String): LienDeliberationTable = LienDeliberationTable(DSL.name(alias), this)
    override fun `as`(alias: Name): LienDeliberationTable = LienDeliberationTable(alias, this)
    override fun `as`(alias: Table<*>): LienDeliberationTable = LienDeliberationTable(alias.getQualifiedName(), this)

    /**
     * Rename this table
     */
    override fun rename(name: String): LienDeliberationTable = LienDeliberationTable(DSL.name(name), null)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): LienDeliberationTable = LienDeliberationTable(name.getQualifiedName(), null)
     ...
     */
    fun <U> mapping(from: (UUID?, UUID?, UUID?, UUID?, String?, String?, Instant?, Instant?) -> U): SelectField<U> = convertFrom(Records.mapping(from))

    /**
     * Convenience mapping calling {@link SelectField#convertFrom(Class,
     * Function)}.
     */
    fun <U> mapping(toType: Class<U>, from: (UUID?, UUID?, UUID?, UUID?, String?, String?, Instant?, Instant?) -> U): SelectField<U> = convertFrom(toType, Records.mapping(from))
}
