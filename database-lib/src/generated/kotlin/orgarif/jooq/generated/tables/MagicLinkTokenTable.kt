...
open class MagicLinkTokenTable(
     ...
     */
    val TOKEN: TableField<MagicLinkTokenRecord, String?> = createField(DSL.name("token"), SQLDataType.VARCHAR(255).nullable(false), this, "")

    /**
     * The column <code>public.magic_link_token.user_id</code>.
     */
    val USER_ID: TableField<MagicLinkTokenRecord, UUID?> = createField(DSL.name("user_id"), SQLDataType.UUID.nullable(false), this, "")

    /**
     * The column <code>public.magic_link_token.validity</code>.
     */
    val VALIDITY: TableField<MagicLinkTokenRecord, Boolean?> = createField(DSL.name("validity"), SQLDataType.BOOLEAN.nullable(false), this, "")

    /**
     * The column <code>public.magic_link_token.creation_date</code>.
     */
    val CREATION_DATE: TableField<MagicLinkTokenRecord, Instant?> = createField(DSL.name("creation_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", TimestampWithTimeZoneToInstantJooqConverter())

    /**
     * The column <code>public.magic_link_token.last_update</code>.
     */
    val LAST_UPDATE: TableField<MagicLinkTokenRecord, Instant?> = createField(DSL.name("last_update"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", TimestampWithTimeZoneToInstantJooqConverter())

    private constructor(alias: Name, aliased: Table<MagicLinkTokenRecord>?): this(alias, null, null, aliased, null)
    private constructor(alias: Name, aliased: Table<MagicLinkTokenRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, aliased, parameters)
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, MagicLinkTokenRecord>): this(Internal.createPathAlias(child, key), child, key, MAGIC_LINK_TOKEN, null)
    ...
    override fun getReferences(): List<ForeignKey<MagicLinkTokenRecord, *>> = listOf(MAGIC_LINK_TOKEN__MAGIC_LINK_TOKEN_USER_ID_FKEY)
    ...
    override fun `as`(alias: String): MagicLinkTokenTable = MagicLinkTokenTable(DSL.name(alias), this)
    override fun `as`(alias: Name): MagicLinkTokenTable = MagicLinkTokenTable(alias, this)
    override fun `as`(alias: Table<*>): MagicLinkTokenTable = MagicLinkTokenTable(alias.getQualifiedName(), this)

    /**
     * Rename this table
     */
    override fun rename(name: String): MagicLinkTokenTable = MagicLinkTokenTable(DSL.name(name), null)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): MagicLinkTokenTable = MagicLinkTokenTable(name.getQualifiedName(), null)
     ...
     */
    fun <U> mapping(from: (String?, UUID?, Boolean?, Instant?, Instant?) -> U): SelectField<U> = convertFrom(Records.mapping(from))

    /**
     * Convenience mapping calling {@link SelectField#convertFrom(Class,
     * Function)}.
     */
    fun <U> mapping(toType: Class<U>, from: (String?, UUID?, Boolean?, Instant?, Instant?) -> U): SelectField<U> = convertFrom(toType, Records.mapping(from))
}
