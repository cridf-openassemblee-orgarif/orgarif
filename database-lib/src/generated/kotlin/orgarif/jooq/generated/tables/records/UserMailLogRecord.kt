...
open class UserMailLogRecord private constructor() : UpdatableRecordImpl<UserMailLogRecord>(UserMailLogTable.USER_MAIL_LOG), Record5<UUID?, UUID?, String?, String?, Instant?> {
    ...
    override fun valuesRow(): Row5<UUID?, UUID?, String?, String?, Instant?> = super.valuesRow() as Row5<UUID?, UUID?, String?, String?, Instant?>
    ...
    override fun values(value1: UUID?, value2: UUID?, value3: String?, value4: String?, value5: Instant?): UserMailLogRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(id: UUID, userId: UUID, mail: String, type: String, creationDate: Instant): this() {
        this.id = id
        this.userId = userId
        this.mail = mail
        this.type = type
