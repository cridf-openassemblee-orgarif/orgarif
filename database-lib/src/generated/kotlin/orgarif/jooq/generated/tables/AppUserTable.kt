...
open class AppUserTable(
     ...
     */
    val ID: TableField<AppUserRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false), this, "")

    /**
     * The column <code>public.app_user.mail</code>.
     */
    val MAIL: TableField<AppUserRecord, String?> = createField(DSL.name("mail"), SQLDataType.VARCHAR(255).nullable(false), this, "")

    /**
     * The column <code>public.app_user.password</code>.
     */
    val PASSWORD: TableField<AppUserRecord, String?> = createField(DSL.name("password"), SQLDataType.VARCHAR(60).nullable(false), this, "")

    /**
     * The column <code>public.app_user.display_name</code>.
     */
    val DISPLAY_NAME: TableField<AppUserRecord, String?> = createField(DSL.name("display_name"), SQLDataType.VARCHAR(255).nullable(false), this, "")

    /**
     * The column <code>public.app_user.language</code>.
     */
    val LANGUAGE: TableField<AppUserRecord, String?> = createField(DSL.name("language"), SQLDataType.VARCHAR(2).nullable(false), this, "")

    /**
     * The column <code>public.app_user.roles</code>.
     */
    val ROLES: TableField<AppUserRecord, Array<String?>?> = createField(DSL.name("roles"), SQLDataType.VARCHAR(255).nullable(false).array(), this, "")

    /**
     * The column <code>public.app_user.signup_date</code>.
     */
    val SIGNUP_DATE: TableField<AppUserRecord, Instant?> = createField(DSL.name("signup_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", TimestampWithTimeZoneToInstantJooqConverter())

    /**
     * The column <code>public.app_user.last_update</code>.
     */
    val LAST_UPDATE: TableField<AppUserRecord, Instant?> = createField(DSL.name("last_update"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", TimestampWithTimeZoneToInstantJooqConverter())
     ...
     */
    fun <U> mapping(from: (UUID?, String?, String?, String?, String?, Array<String?>?, Instant?, Instant?) -> U): SelectField<U> = convertFrom(Records.mapping(from))

    /**
     * Convenience mapping calling {@link SelectField#convertFrom(Class,
     * Function)}.
     */
    fun <U> mapping(toType: Class<U>, from: (UUID?, String?, String?, String?, String?, Array<String?>?, Instant?, Instant?) -> U): SelectField<U> = convertFrom(toType, Records.mapping(from))
}
