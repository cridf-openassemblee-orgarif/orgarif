...
open class DeploymentLogTable(
     ...
     */
    val ID: TableField<DeploymentLogRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false), this, "")

    /**
     * The column <code>public.deployment_log.build_version</code>.
     */
    val BUILD_VERSION: TableField<DeploymentLogRecord, String?> = createField(DSL.name("build_version"), SQLDataType.VARCHAR(255).nullable(false), this, "")

    /**
     * The column <code>public.deployment_log.system_zone_id</code>.
     */
    val SYSTEM_ZONE_ID: TableField<DeploymentLogRecord, String?> = createField(DSL.name("system_zone_id"), SQLDataType.VARCHAR(255).nullable(false), this, "")

    /**
     * The column <code>public.deployment_log.startup_date</code>.
     */
    val STARTUP_DATE: TableField<DeploymentLogRecord, Instant?> = createField(DSL.name("startup_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", TimestampWithTimeZoneToInstantJooqConverter())

    /**
     * The column <code>public.deployment_log.shutdown_date</code>.
     */
    val SHUTDOWN_DATE: TableField<DeploymentLogRecord, Instant?> = createField(DSL.name("shutdown_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "", TimestampWithTimeZoneToInstantJooqConverter())

    private constructor(alias: Name, aliased: Table<DeploymentLogRecord>?): this(alias, null, null, aliased, null)
    private constructor(alias: Name, aliased: Table<DeploymentLogRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, aliased, parameters)
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, DeploymentLogRecord>): this(Internal.createPathAlias(child, key), child, key, DEPLOYMENT_LOG, null)
    ...
    override fun `as`(alias: Table<*>): DeploymentLogTable = DeploymentLogTable(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): DeploymentLogTable = DeploymentLogTable(name.getQualifiedName(), null)
