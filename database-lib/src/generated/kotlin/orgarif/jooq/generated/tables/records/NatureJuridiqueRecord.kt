...
open class NatureJuridiqueRecord private constructor() : UpdatableRecordImpl<NatureJuridiqueRecord>(NatureJuridiqueTable.NATURE_JURIDIQUE), Record5<UUID?, String?, String?, Instant?, Instant?> {
    ...
    override fun field5(): Field<Instant?> = NatureJuridiqueTable.NATURE_JURIDIQUE.LAST_MODIFICATION_DATE
    ...
    override fun values(value1: UUID?, value2: String?, value3: String?, value4: Instant?, value5: Instant?): NatureJuridiqueRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
