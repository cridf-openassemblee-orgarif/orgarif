...
open class UserFileRecord private constructor() : UpdatableRecordImpl<UserFileRecord>(UserFileTable.USER_FILE), Record6<UUID?, UUID?, ByteArray?, String?, String?, Instant?> {
    ...
    override fun valuesRow(): Row6<UUID?, UUID?, ByteArray?, String?, String?, Instant?> = super.valuesRow() as Row6<UUID?, UUID?, ByteArray?, String?, String?, Instant?>
    ...
    override fun values(value1: UUID?, value2: UUID?, value3: ByteArray?, value4: String?, value5: String?, value6: Instant?): UserFileRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(id: UUID, userId: UUID, fileContent: ByteArray, contentType: String, originalFilename: String, uploadDate: Instant): this() {
        this.id = id
        this.userId = userId
