...
open class UserMailLogTable(
     ...
     */
    val ID: TableField<UserMailLogRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false), this, "")

    /**
     * The column <code>public.user_mail_log.user_id</code>.
     */
    val USER_ID: TableField<UserMailLogRecord, UUID?> = createField(DSL.name("user_id"), SQLDataType.UUID.nullable(false), this, "")

    /**
     * The column <code>public.user_mail_log.mail</code>.
     */
    val MAIL: TableField<UserMailLogRecord, String?> = createField(DSL.name("mail"), SQLDataType.VARCHAR(255).nullable(false), this, "")

    /**
     * The column <code>public.user_mail_log.type</code>.
     */
    val TYPE: TableField<UserMailLogRecord, String?> = createField(DSL.name("type"), SQLDataType.VARCHAR(255).nullable(false), this, "")

    /**
     * The column <code>public.user_mail_log.creation_date</code>.
     */
    val CREATION_DATE: TableField<UserMailLogRecord, Instant?> = createField(DSL.name("creation_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", TimestampWithTimeZoneToInstantJooqConverter())

    private constructor(alias: Name, aliased: Table<UserMailLogRecord>?): this(alias, null, null, aliased, null)
    private constructor(alias: Name, aliased: Table<UserMailLogRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, aliased, parameters)
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, UserMailLogRecord>): this(Internal.createPathAlias(child, key), child, key, USER_MAIL_LOG, null)
    ...
    override fun getReferences(): List<ForeignKey<UserMailLogRecord, *>> = listOf(USER_MAIL_LOG__USER_MAIL_LOG_USER_ID_FKEY)
    ...
    override fun `as`(alias: Table<*>): UserMailLogTable = UserMailLogTable(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): UserMailLogTable = UserMailLogTable(name.getQualifiedName(), null)

    // -------------------------------------------------------------------------
    // Row5 type methods
    // -------------------------------------------------------------------------
    override fun fieldsRow(): Row5<UUID?, UUID?, String?, String?, Instant?> = super.fieldsRow() as Row5<UUID?, UUID?, String?, String?, Instant?>

    /**
     * Convenience mapping calling {@link SelectField#convertFrom(Function)}.
     */
    fun <U> mapping(from: (UUID?, UUID?, String?, String?, Instant?) -> U): SelectField<U> = convertFrom(Records.mapping(from))

    /**
     * Convenience mapping calling {@link SelectField#convertFrom(Class,
     * Function)}.
     */
    fun <U> mapping(toType: Class<U>, from: (UUID?, UUID?, String?, String?, Instant?) -> U): SelectField<U> = convertFrom(toType, Records.mapping(from))
}
