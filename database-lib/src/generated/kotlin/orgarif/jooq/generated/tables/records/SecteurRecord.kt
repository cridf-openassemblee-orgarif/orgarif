...
open class SecteurRecord private constructor() : UpdatableRecordImpl<SecteurRecord>(SecteurTable.SECTEUR), Record5<UUID?, String?, String?, Instant?, Instant?> {
    ...
    override fun values(value1: UUID?, value2: String?, value3: String?, value4: Instant?, value5: Instant?): SecteurRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
