...
open class TypeStructureTable(
     ...
     */
    val ID: TableField<TypeStructureRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false), this, "")

    /**
     * The column <code>public.type_structure.libelle</code>.
     */
    val LIBELLE: TableField<TypeStructureRecord, String?> = createField(DSL.name("libelle"), SQLDataType.VARCHAR(255).nullable(false), this, "")

    /**
     * The column <code>public.type_structure.status</code>.
     */
    val STATUS: TableField<TypeStructureRecord, String?> = createField(DSL.name("status"), SQLDataType.VARCHAR(255).nullable(false), this, "")

    /**
     * The column <code>public.type_structure.creation_date</code>.
     */
    val CREATION_DATE: TableField<TypeStructureRecord, Instant?> = createField(DSL.name("creation_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", TimestampWithTimeZoneToInstantJooqConverter())

    /**
     * The column <code>public.type_structure.last_modification_date</code>.
     */
    val LAST_MODIFICATION_DATE: TableField<TypeStructureRecord, Instant?> = createField(DSL.name("last_modification_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", TimestampWithTimeZoneToInstantJooqConverter())

    private constructor(alias: Name, aliased: Table<TypeStructureRecord>?): this(alias, null, null, aliased, null)
    private constructor(alias: Name, aliased: Table<TypeStructureRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, aliased, parameters)
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, TypeStructureRecord>): this(Internal.createPathAlias(child, key), child, key, TYPE_STRUCTURE, null)
    ...
    override fun `as`(alias: Table<*>): TypeStructureTable = TypeStructureTable(alias.getQualifiedName(), this)
     ...
     * Rename this table
     */
    override fun rename(name: Table<*>): TypeStructureTable = TypeStructureTable(name.getQualifiedName(), null)
