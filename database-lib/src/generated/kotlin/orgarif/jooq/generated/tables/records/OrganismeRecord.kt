...
open class OrganismeRecord private constructor() :
    UpdatableRecordImpl<OrganismeRecord>(OrganismeTable.ORGANISME),
    Record11<
        UUID?, String?, UUID?, UUID?, UUID?, UUID?, Int?, Boolean?, String?, Instant?, Instant?> {
    ...
    constructor(
        id: UUID,
        nom: String,
        departementId: UUID? = null,
        natureJuridiqueId: UUID? = null,
        secteurId: UUID? = null,
        typeStructureId: UUID? = null,
