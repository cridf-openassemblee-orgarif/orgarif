...
open class DeliberationRecord private constructor() : UpdatableRecordImpl<DeliberationRecord>(DeliberationTable.DELIBERATION), Record7<UUID?, String?, String?, LocalDate?, String?, Instant?, Instant?> {
    ...
    override fun valuesRow(): Row7<UUID?, String?, String?, LocalDate?, String?, Instant?, Instant?> = super.valuesRow() as Row7<UUID?, String?, String?, LocalDate?, String?, Instant?, Instant?>
    ...
    override fun values(value1: UUID?, value2: String?, value3: String?, value4: LocalDate?, value5: String?, value6: Instant?, value7: Instant?): DeliberationRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(id: UUID, libelle: String, searchLibelle: String, deliberationDate: LocalDate, status: String, creationDate: Instant, lastModificationDate: Instant): this() {
        this.id = id
