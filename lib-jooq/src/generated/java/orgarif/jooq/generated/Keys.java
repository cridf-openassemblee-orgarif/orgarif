...
public class Keys {
    ...
    public static final UniqueKey<InstanceDeliberationRecord> KEY_INSTANCE_DELIBERATION_PRIMARY = UniqueKeys0.KEY_INSTANCE_DELIBERATION_PRIMARY;
    ...
    public static final UniqueKey<RepresentantInstanceRecord> KEY_REPRESENTANT_INSTANCE_PRIMARY = UniqueKeys0.KEY_REPRESENTANT_INSTANCE_PRIMARY;
    public static final UniqueKey<RepresentantOrganismeRecord> KEY_REPRESENTANT_ORGANISME_PRIMARY = UniqueKeys0.KEY_REPRESENTANT_ORGANISME_PRIMARY;
    ...
    public static final ForeignKey<InstanceDeliberationRecord, InstanceRecord> INSTANCE_DELIBERATION_IBFK_1 = ForeignKeys0.INSTANCE_DELIBERATION_IBFK_1;
    public static final ForeignKey<InstanceDeliberationRecord, DeliberationRecord> INSTANCE_DELIBERATION_IBFK_2 = ForeignKeys0.INSTANCE_DELIBERATION_IBFK_2;
    ...
    public static final ForeignKey<RepresentantInstanceRecord, EluRecord> REPRESENTANT_INSTANCE_IBFK_1 = ForeignKeys0.REPRESENTANT_INSTANCE_IBFK_1;
    public static final ForeignKey<RepresentantInstanceRecord, InstanceRecord> REPRESENTANT_INSTANCE_IBFK_2 = ForeignKeys0.REPRESENTANT_INSTANCE_IBFK_2;
    public static final ForeignKey<RepresentantOrganismeRecord, EluRecord> REPRESENTANT_ORGANISME_IBFK_1 = ForeignKeys0.REPRESENTANT_ORGANISME_IBFK_1;
    public static final ForeignKey<RepresentantOrganismeRecord, OrganismeRecord> REPRESENTANT_ORGANISME_IBFK_2 = ForeignKeys0.REPRESENTANT_ORGANISME_IBFK_2;
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<InstanceDeliberationRecord> KEY_INSTANCE_DELIBERATION_PRIMARY = Internal.createUniqueKey(InstanceDeliberationTable.INSTANCE_DELIBERATION, "KEY_instance_deliberation_PRIMARY", new TableField[] { InstanceDeliberationTable.INSTANCE_DELIBERATION.ID }, true);
        ...
        public static final UniqueKey<RepresentantInstanceRecord> KEY_REPRESENTANT_INSTANCE_PRIMARY = Internal.createUniqueKey(RepresentantInstanceTable.REPRESENTANT_INSTANCE, "KEY_representant_instance_PRIMARY", new TableField[] { RepresentantInstanceTable.REPRESENTANT_INSTANCE.ID }, true);
        public static final UniqueKey<RepresentantOrganismeRecord> KEY_REPRESENTANT_ORGANISME_PRIMARY = Internal.createUniqueKey(RepresentantOrganismeTable.REPRESENTANT_ORGANISME, "KEY_representant_organisme_PRIMARY", new TableField[] { RepresentantOrganismeTable.REPRESENTANT_ORGANISME.ID }, true);
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<InstanceDeliberationRecord, InstanceRecord> INSTANCE_DELIBERATION_IBFK_1 = Internal.createForeignKey(Keys.KEY_INSTANCE_PRIMARY, InstanceDeliberationTable.INSTANCE_DELIBERATION, "instance_deliberation_ibfk_1", new TableField[] { InstanceDeliberationTable.INSTANCE_DELIBERATION.INSTANCE_ID }, true);
        public static final ForeignKey<InstanceDeliberationRecord, DeliberationRecord> INSTANCE_DELIBERATION_IBFK_2 = Internal.createForeignKey(Keys.KEY_DELIBERATION_PRIMARY, InstanceDeliberationTable.INSTANCE_DELIBERATION, "instance_deliberation_ibfk_2", new TableField[] { InstanceDeliberationTable.INSTANCE_DELIBERATION.DELIBERATION_ID }, true);
        ...
        public static final ForeignKey<RepresentantInstanceRecord, EluRecord> REPRESENTANT_INSTANCE_IBFK_1 = Internal.createForeignKey(Keys.KEY_ELU_PRIMARY, RepresentantInstanceTable.REPRESENTANT_INSTANCE, "representant_instance_ibfk_1", new TableField[] { RepresentantInstanceTable.REPRESENTANT_INSTANCE.ELU_ID }, true);
        public static final ForeignKey<RepresentantInstanceRecord, InstanceRecord> REPRESENTANT_INSTANCE_IBFK_2 = Internal.createForeignKey(Keys.KEY_INSTANCE_PRIMARY, RepresentantInstanceTable.REPRESENTANT_INSTANCE, "representant_instance_ibfk_2", new TableField[] { RepresentantInstanceTable.REPRESENTANT_INSTANCE.INSTANCE_ID }, true);
        public static final ForeignKey<RepresentantOrganismeRecord, EluRecord> REPRESENTANT_ORGANISME_IBFK_1 = Internal.createForeignKey(Keys.KEY_ELU_PRIMARY, RepresentantOrganismeTable.REPRESENTANT_ORGANISME, "representant_organisme_ibfk_1", new TableField[] { RepresentantOrganismeTable.REPRESENTANT_ORGANISME.ELU_ID }, true);
        public static final ForeignKey<RepresentantOrganismeRecord, OrganismeRecord> REPRESENTANT_ORGANISME_IBFK_2 = Internal.createForeignKey(Keys.KEY_ORGANISME_PRIMARY, RepresentantOrganismeTable.REPRESENTANT_ORGANISME, "representant_organisme_ibfk_2", new TableField[] { RepresentantOrganismeTable.REPRESENTANT_ORGANISME.ORGANISME_ID }, true);
