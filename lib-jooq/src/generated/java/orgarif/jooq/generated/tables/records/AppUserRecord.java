...
public class AppUserRecord extends UpdatableRecordImpl<AppUserRecord> implements Record9<UUID, String, String, String, String, String, Boolean, LocalDateTime, String> {

    private static final long serialVersionUID = 415220023;
    ...
    /**
     * Setter for <code>orgarif.app_user.display_name</code>.
     */
    ...
    /**
     * Getter for <code>orgarif.app_user.display_name</code>.
     */
    @Nonnull
     ...
     */
    public void setSignupDate(@Nonnull LocalDateTime value) {
        set(7, value);
    }
    ...
    @Override
    public Row9<UUID, String, String, String, String, String, Boolean, LocalDateTime, String> valuesRow() {
    ...
    @Override
    public AppUserRecord value8(@Nonnull LocalDateTime value) {
        setSignupDate(value);
        return this;
    }
    ...
    @Override
    public AppUserRecord values(@Nonnull UUID value1, @Nonnull String value2, @Nonnull String value3, @Nullable String value4, @Nonnull String value5, @Nonnull String value6, @Nonnull Boolean value7, @Nonnull LocalDateTime value8, @Nullable String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AppUserRecord(@Nonnull UUID id, @Nonnull String mail, @Nonnull String password, @Nullable String username, @Nonnull String displayName, @Nonnull String language, @Nonnull Boolean admin, @Nonnull LocalDateTime signupDate, @Nullable String dirtyMail) {
        super(AppUserTable.APP_USER);
