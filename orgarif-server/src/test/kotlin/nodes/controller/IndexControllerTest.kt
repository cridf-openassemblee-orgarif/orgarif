...
internal class IndexControllerTest {
    ...
    fun `test magic link url rewriting`() {
        ...
        assertEquals("param1=value1&param2=value2", indexController.rewriteQueryString(mapOf(
        ...
        assertEquals("param1=value11&param1=value12&param2=value2", indexController.rewriteQueryString(mapOf(
