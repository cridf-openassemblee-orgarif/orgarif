...
object OrgarifStringUtils {
    ...
    // problem with this implementation with initial 0 (for instance 0c9e5f71-40c4-4059-b4d9-bb3ec200b6bd)
    // fun serializeUuid(uuid: UUID) = uuid.mostSignificantBits.toHexString() + uuid.leastSignificantBits.toHexString()
