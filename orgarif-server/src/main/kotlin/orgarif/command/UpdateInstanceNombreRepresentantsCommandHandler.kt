...
@Service
class UpdateInstanceNombreRepresentantsCommandHandler(val instanceDao: InstanceDao, val dateService: DateService) :
    CommandHandler.Handler<UpdateInstanceNombreRepresentantsCommand, EmptyCommandResponse>() {

    override fun handle(command: UpdateInstanceNombreRepresentantsCommand):
