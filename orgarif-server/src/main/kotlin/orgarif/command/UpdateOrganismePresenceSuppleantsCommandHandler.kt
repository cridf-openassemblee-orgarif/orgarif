...
@Service
class UpdateOrganismePresenceSuppleantsCommandHandler(val organismeDao: OrganismeDao, val dateService: DateService) :
    ...
    override fun handle(command: UpdateOrganismePresenceSuppleantsCommand): EmptyCommandResponse {
        organismeDao.updatePresenceSuppleants(command.organismeId, command.presenceSuppleants, dateService.now())
