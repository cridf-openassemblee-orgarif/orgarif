...
object ObjectToPropertiesHelper {
    ...
    fun transform(value: Any?, path: String, forcedExclusions: List<String>? = null, depth: Int = 0): List<Pair<String, String>> {
        if (value == null) {
        ...
        return when (value) {
            ...
            is Map<*, *> -> value
                ...
                if (depth > 5) {
                    throw RuntimeException("Can't convert object to properties, max depth reached, failed at $path " +
                            "${value::class}")
                }
    ...
    private fun transformObject(obj: Any, rootPath: String, exceptions: List<String> = emptyList(), depth: Int = 0): List<Pair<String, String>> {
