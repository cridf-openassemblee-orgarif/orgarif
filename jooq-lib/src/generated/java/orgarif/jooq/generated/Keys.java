...
public class Keys {
    ...
    public static final UniqueKey<RepresentationRecord> REPRESENTATION_PKEY = Internal.createUniqueKey(RepresentationTable.REPRESENTATION, DSL.name("representation_pkey"), new TableField[] { RepresentationTable.REPRESENTATION.ID }, true);
    ...
    public static final UniqueKey<SuppleanceRecord> SUPPLEANCE_PKEY = Internal.createUniqueKey(SuppleanceTable.SUPPLEANCE, DSL.name("suppleance_pkey"), new TableField[] { SuppleanceTable.SUPPLEANCE.ID }, true);
    ...
    public static final ForeignKey<RepresentationRecord, InstanceRecord> REPRESENTATION__REPRESENTATION_INSTANCE_ID_FKEY = Internal.createForeignKey(RepresentationTable.REPRESENTATION, DSL.name("representation_instance_id_fkey"), new TableField[] { RepresentationTable.REPRESENTATION.INSTANCE_ID }, Keys.INSTANCE_PKEY, new TableField[] { InstanceTable.INSTANCE.ID }, true);
    public static final ForeignKey<RepresentationRecord, OrganismeRecord> REPRESENTATION__REPRESENTATION_ORGANISME_ID_FKEY = Internal.createForeignKey(RepresentationTable.REPRESENTATION, DSL.name("representation_organisme_id_fkey"), new TableField[] { RepresentationTable.REPRESENTATION.ORGANISME_ID }, Keys.ORGANISME_PKEY, new TableField[] { OrganismeTable.ORGANISME.ID }, true);
    public static final ForeignKey<RepresentationRecord, RepresentantRecord> REPRESENTATION__REPRESENTATION_REPRESENTANT_ID_FKEY = Internal.createForeignKey(RepresentationTable.REPRESENTATION, DSL.name("representation_representant_id_fkey"), new TableField[] { RepresentationTable.REPRESENTATION.REPRESENTANT_ID }, Keys.REPRESENTANT_PKEY, new TableField[] { RepresentantTable.REPRESENTANT.ID }, true);
    public static final ForeignKey<SuppleanceRecord, OrganismeRecord> SUPPLEANCE__SUPPLEANCE_ORGANISME_ID_FKEY = Internal.createForeignKey(SuppleanceTable.SUPPLEANCE, DSL.name("suppleance_organisme_id_fkey"), new TableField[] { SuppleanceTable.SUPPLEANCE.ORGANISME_ID }, Keys.ORGANISME_PKEY, new TableField[] { OrganismeTable.ORGANISME.ID }, true);
    public static final ForeignKey<SuppleanceRecord, RepresentantRecord> SUPPLEANCE__SUPPLEANCE_REPRESENTANT_ID_FKEY = Internal.createForeignKey(SuppleanceTable.SUPPLEANCE, DSL.name("suppleance_representant_id_fkey"), new TableField[] { SuppleanceTable.SUPPLEANCE.REPRESENTANT_ID }, Keys.REPRESENTANT_PKEY, new TableField[] { RepresentantTable.REPRESENTANT.ID }, true);
    public static final ForeignKey<SuppleanceRecord, RepresentationRecord> SUPPLEANCE__SUPPLEANCE_REPRESENTATION_ID_FKEY = Internal.createForeignKey(SuppleanceTable.SUPPLEANCE, DSL.name("suppleance_representation_id_fkey"), new TableField[] { SuppleanceTable.SUPPLEANCE.REPRESENTATION_ID }, Keys.REPRESENTATION_PKEY, new TableField[] { RepresentationTable.REPRESENTATION.ID }, true);
