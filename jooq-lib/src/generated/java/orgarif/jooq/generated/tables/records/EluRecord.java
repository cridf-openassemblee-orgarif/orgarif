...
public class EluRecord extends UpdatableRecordImpl<EluRecord> implements Record9<UUID, String, String, String, String, String, String, Boolean, Instant> {
    ...
    @Override
    @Nonnull
    public Row9<UUID, String, String, String, String, String, String, Boolean, Instant> valuesRow() {
    ...
    @Override
    @Nonnull
    public EluRecord values(@Nonnull UUID value1, @Nonnull String value2, @Nonnull String value3, @Nonnull String value4, @Nonnull String value5, @Nonnull String value6, @Nonnull String value7, @Nonnull Boolean value8, @Nonnull Instant value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EluRecord(@Nonnull UUID id, @Nonnull String civilite, @Nonnull String prenom, @Nonnull String nom, @Nonnull String groupePolitique, @Nonnull String groupePolitiqueCourt, @Nonnull String imageUrl, @Nonnull Boolean actif, @Nonnull Instant creationDate) {
        super(EluTable.ELU);
