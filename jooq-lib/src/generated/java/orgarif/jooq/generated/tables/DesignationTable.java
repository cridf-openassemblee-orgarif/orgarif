...
public class DesignationTable extends TableImpl<DesignationRecord> {
     ...
     */
    public final TableField<DesignationRecord, Instant> CREATION_DATE = createField(DSL.name("creation_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", new TimestampWithTimeZoneToInstantConverter());

    /**
     * The column <code>public.designation.last_modification_date</code>.
     */
    public final TableField<DesignationRecord, Instant> LAST_MODIFICATION_DATE = createField(DSL.name("last_modification_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", new TimestampWithTimeZoneToInstantConverter());
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.DESIGNATION_INSTANCE_ID_IDX, Indexes.DESIGNATION_ORGANISME_ID_IDX);
    }
    ...
    @Override
    @Nonnull
    public List<UniqueKey<DesignationRecord>> getKeys() {
        return Arrays.<UniqueKey<DesignationRecord>>asList(Keys.DESIGNATION_PKEY);
    }

    @Override
    @Nonnull
    public List<ForeignKey<DesignationRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<DesignationRecord, ?>>asList(Keys.DESIGNATION__DESIGNATION_REPRESENTANT_ID_FKEY, Keys.DESIGNATION__DESIGNATION_ORGANISME_ID_FKEY, Keys.DESIGNATION__DESIGNATION_INSTANCE_ID_FKEY);
    }
