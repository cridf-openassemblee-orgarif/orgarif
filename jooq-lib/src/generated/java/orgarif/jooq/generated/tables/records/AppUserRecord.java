...
public class AppUserRecord extends UpdatableRecordImpl<AppUserRecord> implements Record10<UUID, String, String, String, String, String, String[], Instant, String, String[]> {
    ...
    /**
     * Setter for <code>public.app_user.former_mails</code>.
     */
    public void setFormerMails(@Nonnull String[] value) {
        set(9, value);
    }

    /**
     * Getter for <code>public.app_user.former_mails</code>.
     */
    @Nonnull
    public String[] getFormerMails() {
        return (String[]) get(9);
    }
    ...
    @Override
    @Nonnull
    public Row10<UUID, String, String, String, String, String, String[], Instant, String, String[]> valuesRow() {
    ...
    public Field<String[]> field10() {
        return AppUserTable.APP_USER.FORMER_MAILS;
    }
    ...
    @Override
    @Nonnull
    public AppUserRecord value9(@Nullable String value) {
        setDirtyMail(value);
        return this;
    }
    ...
    @Override
    @Nonnull
    public AppUserRecord value10(@Nonnull String[] value) {
        setFormerMails(value);
        return this;
    }

    @Override
    @Nonnull
    public AppUserRecord values(@Nonnull UUID value1, @Nonnull String value2, @Nonnull String value3, @Nullable String value4, @Nonnull String value5, @Nonnull String value6, @Nonnull String[] value7, @Nonnull Instant value8, @Nullable String value9, @Nonnull String[] value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AppUserRecord(@Nonnull UUID id, @Nonnull String mail, @Nonnull String password, @Nullable String username, @Nonnull String displayName, @Nonnull String language, @Nonnull String[] roles, @Nonnull Instant signupDate, @Nullable String dirtyMail, @Nonnull String[] formerMails) {
        super(AppUserTable.APP_USER);
