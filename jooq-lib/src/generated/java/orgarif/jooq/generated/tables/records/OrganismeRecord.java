...
public class OrganismeRecord extends UpdatableRecordImpl<OrganismeRecord> implements Record10<UUID, String, UUID, UUID, UUID, Integer, Integer, Boolean, Instant, Instant> {
    ...
    @Override
    @Nonnull
    public Row10<UUID, String, UUID, UUID, UUID, Integer, Integer, Boolean, Instant, Instant> valuesRow() {
    ...
    @Override
    @Nonnull
    public OrganismeRecord values(@Nonnull UUID value1, @Nonnull String value2, @Nullable UUID value3, @Nullable UUID value4, @Nullable UUID value5, @Nullable Integer value6, @Nullable Integer value7, @Nonnull Boolean value8, @Nonnull Instant value9, @Nonnull Instant value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
