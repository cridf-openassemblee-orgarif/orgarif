...
public class OrganismeRecord extends UpdatableRecordImpl<OrganismeRecord> implements Record10<UUID, String, UUID, UUID, UUID, Integer, Boolean, Instant, String, Instant> {
    ...
    @Override
    @Nonnull
    public Row10<UUID, String, UUID, UUID, UUID, Integer, Boolean, Instant, String, Instant> valuesRow() {
    ...
    @Override
    @Nonnull
    public OrganismeRecord value7(@Nonnull Boolean value) {
    ...
    @Override
    @Nonnull
    public OrganismeRecord value8(@Nonnull Instant value) {
    ...
    @Override
    @Nonnull
    public OrganismeRecord values(@Nonnull UUID value1, @Nonnull String value2, @Nullable UUID value3, @Nullable UUID value4, @Nullable UUID value5, @Nullable Integer value6, @Nonnull Boolean value7, @Nonnull Instant value8, @Nonnull String value9, @Nonnull Instant value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OrganismeRecord(@Nonnull UUID id, @Nonnull String nom, @Nullable UUID secteurId, @Nullable UUID natureJuridiqueId, @Nullable UUID typeStructureId, @Nullable Integer nombreRepresentants, @Nonnull Boolean presenceSuppleants, @Nonnull Instant creationDate, @Nonnull String status, @Nonnull Instant lastModificationDate) {
        super(OrganismeTable.ORGANISME);
