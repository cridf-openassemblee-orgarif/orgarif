...
public class InstanceRecord extends UpdatableRecordImpl<InstanceRecord> implements Record8<UUID, String, UUID, Integer, Boolean, Instant, String, Instant> {
    ...
    @Override
    @Nonnull
    public Row8<UUID, String, UUID, Integer, Boolean, Instant, String, Instant> valuesRow() {
    ...
    @Override
    @Nonnull
    public InstanceRecord values(@Nonnull UUID value1, @Nonnull String value2, @Nonnull UUID value3, @Nullable Integer value4, @Nonnull Boolean value5, @Nonnull Instant value6, @Nonnull String value7, @Nonnull Instant value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public InstanceRecord(@Nonnull UUID id, @Nonnull String nom, @Nonnull UUID organismeId, @Nullable Integer nombreRepresentants, @Nonnull Boolean presenceSuppleants, @Nonnull Instant creationDate, @Nonnull String status, @Nonnull Instant lastModificationDate) {
        super(InstanceTable.INSTANCE);
