...
public class InstanceRecord extends UpdatableRecordImpl<InstanceRecord> implements Record7<UUID, String, UUID, Integer, Instant, String, Instant> {
    ...
    @Override
    @Nonnull
    public Row7<UUID, String, UUID, Integer, Instant, String, Instant> valuesRow() {
    ...
    @Override
    @Nonnull
    public InstanceRecord value5(@Nonnull Instant value) {
    ...
    @Override
    @Nonnull
    public InstanceRecord values(@Nonnull UUID value1, @Nonnull String value2, @Nonnull UUID value3, @Nullable Integer value4, @Nonnull Instant value5, @Nonnull String value6, @Nonnull Instant value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public InstanceRecord(@Nonnull UUID id, @Nonnull String nom, @Nonnull UUID organismeId, @Nullable Integer nombreRepresentants, @Nonnull Instant creationDate, @Nonnull String status, @Nonnull Instant lastModificationDate) {
        super(InstanceTable.INSTANCE);
