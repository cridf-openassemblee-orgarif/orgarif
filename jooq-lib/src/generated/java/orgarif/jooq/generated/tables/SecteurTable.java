...
public class SecteurTable extends TableImpl<SecteurRecord> {
     ...
     */
    public final TableField<SecteurRecord, Instant> CREATION_DATE = createField(DSL.name("creation_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", new TimestampWithTimeZoneToInstantConverter());
